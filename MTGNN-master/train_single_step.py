...
from net1 import gtnet1
from net2 import gtnet2
import numpy as np
import importlib
...
parser.add_argument('--seq_in_len',type=int,default=168,help='input sequence length')#168长度
parser.add_argument('--seq_out_len',type=int,default=1,help='output sequence length')
parser.add_argument('--horizon', type=int, default=6)
parser.add_argument('--layers',type=int,default=5,help='number of layers')
parser.add_argument('--cycle', type=int, default= 24)#周期 ex 7; solar 72; traffic 24
...
def main():
    ...
    model = gtnet2(args.batch_size,args.horizon,args.cycle,args.gcn_true, args.buildA_true, args.gcn_depth, args.num_nodes,
